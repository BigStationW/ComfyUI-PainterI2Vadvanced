...
class PainterI2VAdvancedTiled(io.ComfyNode):
    """Enhanced Wan2.2 I2V node with tiled VAE encoding and post-correction color drift prevention for dual-sampler workflow"""
    
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="PainterI2VAdvancedTiled",
            display_name="PainterI2VAdvanced (Tiled)",
            category="conditioning/video_models",
            inputs=[
                io.Conditioning.Input("positive"),
                io.Conditioning.Input("negative"),
                ...
                io.Int.Input("tile_size", default=512, min=64, max=4096, step=64,
                           tooltip="Tile size for tiled VAE encoding."),
                io.Int.Input("overlap", default=64, min=0, max=4096, step=32,
                           tooltip="Overlap between tiles for tiled VAE encoding."),
    ...
    def execute(cls, positive, negative, vae, width, height, length, batch_size,
        ...
        if start_image is not None:
            ...
            # Use tiled encoding — pass tile sizes directly as VAEEncodeTiled does
            ...
            # Use tiled encoding for reference latent as well
...
class PainterI2VAdvancedExtension(ComfyExtension):
    ...
    async def get_node_list(self) -> list[type[io.ComfyNode]]:
        return [PainterI2VAdvanced, PainterI2VAdvancedTiled]
...
NODE_CLASS_MAPPINGS = {
    ...
    "PainterI2VAdvancedTiled": PainterI2VAdvancedTiled,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "PainterI2VAdvanced": "PainterI2VAdvanced",
    "PainterI2VAdvancedTiled": "PainterI2VAdvanced (Tiled)",
}
